<p align="center">
  <img src="تصاویر/۱.png" width="۱۸٪" />
  <img src="تصاویر/۲.png" width="۱۸٪" />
  <img src="تصاویر/۳.png" width="۱۸٪" />
  <img src="تصاویر/۱۴.png" width="۱۸٪" />
  <img src="تصاویر/۴.png" width="۱۸٪" />
</p>
...
<details>
  ...
  <br>
  <p align="center">
    <img src="تصاویر/۶.png" width="۱۸٪" />
    <img src="تصاویر/۷.png" width="۱۸٪" />
    <img src="تصاویر/۸.png" width="۱۸٪" />
    <img src="تصاویر/۹.png" width="۱۸٪" />
    <img src="تصاویر/۱۰.png" width="۱۸٪" />
    <br><br>
    <img src="تصاویر/۵.png" width="۱۸٪" />
    <img src="تصاویر/۱۱.png" width="۱۸٪" />
    <img src="تصاویر/۱۲.png" width="۱۸٪" />
    <img src="تصاویر/۱۳.png" width="۱۸٪" />
    <img src="تصاویر/۱۵.png" width="۱۸٪" />
    <img src="تصاویر/۱۶.png" width="۱۸٪" />
  </p>
</details>

<p align="center">
  <b>دریافت نسخه آزمایشی برنامه</b>
</p>
...
# سخنی با صاحبان دردهای بی‌صدا

## آنان که جای خالی عزیزی را در سینه دارند
...
هدف «ایران من» ساختن یک سامانه صرفاً اداری نیست؛ هدف، ایجاد یک **زیرساخت اعتماد دیجیتال** میان مردم، حکومت و خدمات عمومی است؛ زیرساختی که در آن فناوری در خدمت حقوق شهروندان قرار می‌گیرد و هیچ فرد یا نهاد واحدی نباید به‌تنهایی بتواند کنترل کامل سیستم را در اختیار داشته باشد.
...
## 📜 قانون اساسی: بنیان تغییرناپذیر

پیش از ورود به هر مرحله دیگر «ایران من»، مرحله نخست باید تکمیل و تصویب شود: نگارش و تصویب یک **قانون اساسی مدرن و حقوق‌محور**.

تا این مرحله کامل نشود، سیستم وارد مراحل بعدی نخواهد شد.

روند نگارش و ماهیت این قانون به شرح زیر است:
...
* **حدنصاب تغییر اصول بنیادین:** برای نمونه می‌توان ۷۵ درصد رأی مثبت، در سه دور جداگانه با حداقل شش ماه فاصله و مشارکت حداقل ۶۰ درصد واجدان رأی را در نظر گرفت. این اعداد صرفاً نمونه هستند و مقدار نهایی باید در فرآیند تدوین قانون اساسی تعیین شود.
...
اما عملکرد او نباید صرفاً با محبوبیت عمومی سنجیده شود.
...
محبوبیت عمومی تنها یکی از شاخص‌هاست و نباید به‌تنهایی باعث عزل یک مسئول شود.
...
اما تحلیل احساسات مردم فقط یک شاخص آماری است و نباید به‌تنهایی باعث مجازات، عزل یا کاهش حقوق یک مسئول شود.
...
* **مسیر گفت‌وگو:** مسئولان می‌توانند صفحه عمومی داشته باشند و مردم بتوانند نظر، نقد و پیشنهاد خود را در آن ثبت کنند.
...
* **امنیت زنجیره تأمین:** کدها، کتابخانه‌ها، وابستگی‌ها، فرایند ساخت و انتشار نرم‌افزار باید قابل بررسی و ممیزی باشند.
...
اگر این اصول از مرحله طراحی تا مرحله اجرا واقعاً رعایت شوند، «ایران من» می‌تواند از یک ایده نرم‌افزاری فراتر برود و به زیرساختی تبدیل شود که خدمات عمومی، مشارکت شهروندان و اعتماد میان مردم و حکومت بر پایه آن شکل بگیرد.
